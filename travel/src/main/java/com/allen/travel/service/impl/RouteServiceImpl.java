...
import com.allen.travel.dao.RouteDao;
...
import com.allen.travel.dao.impl.RouteDaoImpl;
import com.allen.travel.dao.impl.RouteImgDaoImpl;
import com.allen.travel.dao.impl.SellerDaoImpl;
...
public class RouteServiceImpl implements RouteService {
    ...
    public Route findOne(String rid) {
        ...
        //3、根据route的sid查询商家对象的信息
        Seller seller = sellerDao.findById(route.getSid());
        route.setSeller(seller);

        //4、查询收藏次数
        int count = favorityDao.findCountByRid(route.getRid());
